 ...
 *
 * Modified by AzureSonw for SonwMusicBot.
 */
...
public class JMusicBot
{
    ...
    {
        UserInteraction userInteraction = new Prompt("SonwMusicBot");
        ...
        if (!InstanceLock.tryAcquire()) {
            userInteraction.alert(Prompt.Level.ERROR, "SonwMusicBot",
                    "Another instance of SonwMusicBot is already running.\n" +
        ...
        {
            userInteraction.alert(Prompt.Level.ERROR, "SonwMusicBot", "Invalid response from Discord. Check your internet connection.");
            System.exit(1);
        }
        catch(Exception ex)
        {
