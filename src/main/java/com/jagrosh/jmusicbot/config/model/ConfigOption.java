...
public enum ConfigOption {
    ...
    APPLE_MUSIC_COUNTRY_CODE("playback.appleMusic.countryCode", ConfigType.STRING, false, "Apple Music catalog country code"),
    APPLE_MUSIC_MEDIA_API_TOKEN("playback.appleMusic.mediaAPIToken", ConfigType.STRING, false, "Apple Music media API token"),
    ...
    MAX_APPLE_MUSIC_PLAYLIST_PAGES("playback.appleMusic.maxPlaylistPages", ConfigType.INT, false, "Maximum Apple Music playlist pages to load"),
    MAX_APPLE_MUSIC_ALBUM_PAGES("playback.appleMusic.maxAlbumPages", ConfigType.INT, false, "Maximum Apple Music album pages to load"),
    MAX_BILIBILI_PLAYLIST_PAGES("playback.bilibili.maxPlaylistPages", ConfigType.INT, false, "Maximum Bilibili playlist/favorite/season pages to load"),
