...
public class BotConfig {
    ...
    private String token, prefix, altprefix, helpWord, playlistsFolder, logLevel,
            ...
            evalEngine, appleMusicCountryCode, appleMusicMediaApiToken;
    private boolean stayInChannel, songInGame, npImages, updatealerts, useEval, dbots, useYouTubeOauth;
    private long owner, maxSeconds, aloneTimeUntilStop;
    private int maxYTPlaylistPages, maxAppleMusicPlaylistPages, maxAppleMusicAlbumPages,
            maxBilibiliPlaylistPages;
    ...
    private void loadConfigValues(Config config, Config migratedUserConfig) {
        ...
        appleMusicCountryCode = APPLE_MUSIC_COUNTRY_CODE.getString(config);
        appleMusicMediaApiToken = APPLE_MUSIC_MEDIA_API_TOKEN.getString(config);
        maxAppleMusicPlaylistPages = MAX_APPLE_MUSIC_PLAYLIST_PAGES.getInt(config);
        maxAppleMusicAlbumPages = MAX_APPLE_MUSIC_ALBUM_PAGES.getInt(config);
        maxBilibiliPlaylistPages = MAX_BILIBILI_PLAYLIST_PAGES.getInt(config);
    ...
    public String getAppleMusicCountryCode() {
        return appleMusicCountryCode;
    }

    public String getAppleMusicMediaApiToken() {
        return appleMusicMediaApiToken;
    }

    public int getMaxAppleMusicPlaylistPages() {
        return maxAppleMusicPlaylistPages;
    }

    public int getMaxAppleMusicAlbumPages() {
        return maxAppleMusicAlbumPages;
    }

    public int getMaxBilibiliPlaylistPages() {
        return maxBilibiliPlaylistPages;
    }
